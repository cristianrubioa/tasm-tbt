...
;   ** cuando queremos mover datos de la memoria usamos "si" **
...
;    ** 41h y 5ah (Rango de minusculas) **

  cmp al,41h                        ;Se compara con a
  jb INICIO                         ;Si es menor salta a "INICIO"

  cmp al,5ah                        ;Se compara z
  ja INICIO                         ;Si es mayor salta a "INICIO"

  add al,20h                        ;Se resta 20h al caracter almacenado en "al"
